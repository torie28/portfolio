...
const logos = [
  { name: "TypeScript", width: 100 },
  { name: "React", width: 80 },
  { name: "Next.js", width: 90 },
  { name: "Node.js", width: 100 },
  { name: "Tailwind CSS", width: 70 },
  { name: "Framer Motion", width: 90 },
  { name: "Git", width: 100 },
...
export function LogoMarquee() {
  ...
  return (
    <section ref={ref} className="py-16 overflow-hidden">
      ...
      >
        <p className="text-sm text-zinc-500 uppercase tracking-wider font-medium">Technologies I work with</p>
      </motion.div>
